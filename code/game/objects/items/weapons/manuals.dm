...
//big pile of shit below.
	...
	dat = {"<html>
				...
				So thereвАЩs 50 dead people lying on the floor, chairs are spinning like no tomorrow and you havenвАЩt the foggiest idea of what to do? Not to worry! This guide is intended to teach you how to clone people and how to do it right, in a simple step-by-step process! If at any point of the guide you have a mental meltdown, genetics probably isnвАЩt for you and you should get a job-change as soon as possible before youвАЩre sued for malpractice.
				...
				The cloning machine does not like abiotic items. What this means is you canвАЩt clone anyone if theyвАЩre wearing clothes, so take all of it off. If itвАЩs just one person, itвАЩs courteous to put their possessions in the closet. If you have about seven people awaiting cloning, just leave the piles where they are, but donвАЩt mix them around and for GodвАЩs sake donвАЩt let the Clown in to steal them.

				<a name='3'><H4>Step 3: Put body in cloning machine</H4>
				Grab the body and then put it inside the DNA modifier. If you cannot do this, then you messed up at Step 2. Go back and check you took EVERYTHING off - a commonly missed item is their headset.

				<a name='4'><H4>Step 4: Scan body</H4>
				Go onto the computer and scan the body by pressing вАШScan - <Subject Name Here>вАЩ. If youвАЩre successful, they will be added to the records (note that this can be done at any time, even with living people, so that they can be cloned without a body in the event that they are lying dead on port solars and didnвАШt turn on their suit sensors)! If not, and it says вАЬError: Mental interface failure.вАЭ, then they have left their bodily confines and are one with the spirits. If this happens, just shout at them to get back in their body, click вАШRefreshвАШ and try scanning them again. If thereвАЩs no success, threaten them with gibbing. Still no success? Skip over to Step 7 and donвАШt continue after it, as you have an unresponsive body and it cannot be cloned. If you got вАЬError: Unable to locate valid genetic data.вАЬ, you are trying to clone a monkey - start over.

				<a name='5'><H4>Step 5: Clone body</H4>
				Now that the body has a record, click вАЩView RecordsвАЩ, click the subjectвАЩs name, and then click вАШCloneвАЩ to start the cloning process. Congratulations! YouвАЩre halfway there. Remember not to вАШEjectвАЩ the cloning pod as this will kill the developing clone and youвАЩll have to start the process again.

				<a name='6'><H4>Step 6: Get clean SEs for body</H4>
				Cloning is a finicky and unreliable process. Whilst it will most certainly bring someone back from the dead, they can have any number of nasty disabilities given to them during the cloning process! For this reason, you need to prepare a clean, defect-free Structural Enzyme (SE) injection for when theyвАЩre done. If youвАЩre a competent Geneticist, you will already have one ready on your working computer. If, for any reason, you do not, then eject the body from the DNA modifier (NOT THE CLONING POD) and take it next door to the Genetics research room. Put the body in one of those DNA modifiers and then go onto the console. Go into View/Edit/Transfer Buffer, find an open slot and click вАЬSEвАЬ to save it. Then click вАШInjectorвАЩ to get the SEs in syringe form. Put this in your pocket or something for when the body is done.

				<a name='7'><H4>Step 7: Put body in morgue</H4>
				Now that the cloning process has been initiated and you have some clean Structural Enzymes, you no longer need the body! Drag it to the morgue and tell the Chef over the radio that they have some fresh meat waiting for them in there. To put a body in a morgue bed, simply open the tray, grab the body, put it on the open tray, then close the tray again. Use one of the nearby pens to label the bed вАЬCHEF MEATвАЭ in order to avoid confusion.

				<a name='8'><H4>Step 8: Await cloned body</H4>
				Now go back to the lab and wait for your patient to be cloned. It wonвАЩt be long now, I promise.

				<a name='9'><H4>Step 9: Use the clean SE injector on person</H4>
				Has your body been cloned yet? Great! As soon as the guy pops out, grab your injector and jab it in them. Once youвАЩve injected them, they now have clean Structural Enzymes and their defects, if any, will disappear in a short while.

				<a name='10'><H4>Step 10: Give person clothes back</H4>
				Obviously the person will be naked after they have been cloned. Provided you werenвАЩt an irresponsible little shit, you should have protected their possessions from thieves and should be able to give them back to the patient. No matter how cruel you are, itвАЩs simply against protocol to force your patients to walk outside naked.

				<a name='11'><H4>Step 11: Send person on their way</H4>
				Give the patient one last check-over - make sure they donвАЩt still have any defects and that they have all their possessions. Ask them how they died, if they know, so that you can report any foul play over the radio. Once youвАЩre done, your patient is ready to go back to work! Chances are they do not have Medbay access, so you should let them out of Genetics and the Medbay main entrance.

				<p>If youвАЩve gotten this far, congratulations! You have mastered the art of cloning. Now, the real problem is how to resurrect yourself after that traitor had his way with you for cloning his target.
...
/obj/item/weapon/book/manual/bulldog
	name = "Fission Mailed: Bulldog Base Management Instruction"
	icon_state ="bookBulldog"
	author = "Syndicate"
	title = "Fission Mailed: Bulldog Base Management Instruction"
	dat = {"<html>
			<b><center>»нструкция по управлению базой синдиката "Ѕульдог-03":</center></b><br><br>
			ѕриветствуем вас, дорогой читатель. —пасибо за выбор нашей базы в качестве основного рабочего пункта.<br>
			—егодня мы попробуем рассказать ¬ам об основных правилах и основах руководства на данной палубе.<br>
			¬о-первых, самое важное, Ќ≈ ѕќ »ƒј…“≈ Ѕј«” ƒќ “ќ√ќ,  ј  ѕќЋ”„»“≈ –ј«–≈Ў≈Ќ»≈ ” ЌјЎ≈√ќ  ќћјЌƒќ¬јЌ»я!<br>
			¬о-вторых, астеройдная база "Ѕульдог-03" оснащена мощнейшей взрывчаткой с таймеров в соседней комнате.<br>
			≈сли вдруг конфеденциальность постройки будет под угрозой, немедленно сообщите нам об этом и получите разрешени на подрыв бомбы с эвакуацией.<br>
			<b>»так, по поводу того, какой экипаж предусмотрен базой на данный момент:</b><br>
			<li>»нженер синдиката - 1 капсула.</li>
			<li>’имик синдиката - 2 капсулы.</li>
			<li>¬ирусолог синдиката - 1 капсула.</li>
			<li>Ѕотаник синдиката - 1 капсула.</li>
			<li>—вязист синдиката (лидер базы) - 1 капсула.</li>
			¬ам стоит понимать, что основная задача базы "Ѕульдог-03" - производство и исследование запрещенного корпорацией Ќ“ биологического оружия.<br>
			¬ соседнем секторе располагается секретная космическая станция " расный Ћазарь", принадлежащая корпорации Ќанотрезен.<br>
			«апомни: " расный Ћазарус" - не цель для экспериментов. ƒля экспериментов у вас есть тестовый полигон и целая порция мартышек.<br>
			” вас нету возможности прямой стыковке к станции, однако вы можете высадиться на Ћаваленд для атаки базы шахтеров.<br>
			ѕомните, что при желании вы можете запросить у ÷ентрального  омандования —индиката разрешение для полноценной атаки базы.<br>
			 ак только вы приготовите эксперементальное био-оружие (гранаты, вирусы, растения), вы также должны сообщить об этом нам.<br>
			—вязист синдиката на базе "Ѕульдог-03" является лидером экипажа и стоит на самой высокой ступени в иерархии командования.<br>
			–уководите управлением, отдавайте приказы, вы имеете полный доступ ко всему оборудованию, включая APC.<br>
			≈сли у вас возникнут определенные потребности в еде, припасах или заданиях, смело обращайтесь к нам через консоль.<br>
			<b>ƒля того, чтобы полноценно использовать консоль коммуникации, вам стоит выполнить следующее:</b><br>
			<li>¬зять емаго-карту.</li>
			<li>ѕровести картой по консоли коммуникации.</li>
			<li>—вязаться с ÷ —.</li>
			ѕомимо всего этого, вы должны понять важнейший момент: сохранение статуса полной конфеденциальности вашего существование - ваша первостепенная задача.<br>
			<b>” вас есть возможность разведовать ситуацию на станции " расный Ћазарь", используя необходимое для этого оборудование:</b><br>
			<li> онсоль слежения через камеры станции.</li>
			<li>»нтеркомы и наушники для прослушивания переговоров работников.</li>
			» повторяем ¬ам: Ќ≈ —ћ≈…“≈ –ј«√ќ¬ј–»¬ј“№ — Ё »ѕј∆≈ћ —“јЌ÷»» " –ј—Ќџ… Ћј«ј–№" Ѕ≈« ЌјЎ≈√ќ ѕ–яћќ√ќ –ј«–≈Ў≈Ќ»я!
			∆елаем удачи. ѕомните порядок: анонимность, продуктивность, кооперативность, информативность.<br>
			<b>ѕо любым интересующим ¬ас вопросам, ¬ы всегда можете обратиться к нам через консоль коммуникации.</b><br>
			∆елаем удачи!
			</html>"}
