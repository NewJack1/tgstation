...
/obj/machinery/computer/message_monitor
	...
	var/rebootmsg = "<span class='warning'>%$&(пїЅ: Critical %$$@ Error // !RestArting! <lOadiNg backUp iNput ouTput> - ?pLeaSe wAit!</span>"
	//Computer properties
...
/obj/machinery/computer/message_monitor/emag_act(mob/user)
	if(!emagged)
		if(!isnull(src.linkedServer))
			...
			MK.info += "<br><br><font color='red'>пїЅ%@%(*$%&(пїЅ&?*(%&пїЅ/{}</font>"
