...
/datum/language
	var/name = "Ќеизвестный язык."  // Fluff name of language if any.
	...
	var/list/signlang_verb = list("показывает", "жестикулирует") // list of emotes that might be displayed if this language has NONVERBAL or SIGNLANG flags
